...
# =============================================================================
import pandas as pd
dataset6 = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_06.csv')
...
# =============================================================================
d6 = dataset6.copy()
d6_0=d6[d6.waterfront==0]['price'].mean()
d6_1=d6[d6.waterfront==1]['price'].mean()
...
data = d6.drop(['id','date','zipcode'],axis=1)
X= data.drop('price',axis=1)
y =data.price
from statsmodels.formula.api import ols
X.columns
ols1=ols('price~bedrooms+bathrooms+sqft_living+sqft_lot+floors+       waterfront+view+condition+grade+sqft_above+sqft_basement+yr_built+yr_renovated+sqft_living15+sqft_lot15',
    data=data).fit()
...
q3=d6.drop(columns=['id','date','zipcode'])
x_var = q3.columns.drop('price')
from statsmodels.formula.api import ols
form = 'price~'+'+'.join(x_var)
ols1_1 = ols(form,data=q3).fit()
ols1_1.summary()

sum(ols1_1.pvalues<0.05)-1
#%%
...
# =============================================================================
dataset7 = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_07.csv')
...
# =============================================================================
q1 =d7[['GRE', 'TOEFL', 'CGPA','Chance_of_Admit']].corr()
q1.iloc[:-1,-1].max()
...
#%%
dataset8 = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_08.csv')
...
mape = (abs(temp.Profit - pred_NY)/temp.Profit).sum()*100/len(temp)
...
# from sklearn.linear_model import LinearRegression
# =============================================================================
dataset10 = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_10.csv')
