...
# =============================================================================
import pandas as pd
dataset11 = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_11.csv')
...
# 활용하시오.(답안 예시) 1
# =============================================================================
q1 = pd.pivot_table(data=dataset11,index='Country',
...
# C() 강제적으로 변수형으로 변환
form = 'Happiness_Score~C(year)'
q3 = dataset11[dataset11['Country'].isin(q1_2.index.values)]

anova = ols(form,data=q3).fit()
...
# =============================================================================
# =============================================================================
dataset12 = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_12.csv')
...
# =============================================================================
df = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_13_train.csv')
q1m=df[df['gender']=='Male'][['relevent_experience','last_new_job']]
q1f=df[df['gender']=='Female'][['relevent_experience','last_new_job']]
q1m.corr()
#  0.098156
q1f.corr()
# 0.108429
...
df_q2=\
    df.loc[(df['major_discipline']=='STEM')&
                (df['city_development_index']>df['city_development_index'].percentile(0.85)),]
...
test = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_13_test.csv')
...
#%%
df = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_14.csv')
# =============================================================================
...
# =============================================================================
import pandas as pd
pos = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_05_Mart_POS.csv')
lis = pd.read_csv('C:/Users/SEC/OneDrive/바탕 화면/Dataset/Dataset_05_item_list.csv')
...
# 1. 데이터셋 결합 2. 요일 3. 1분기 데이터 필터링 .month 

q2 = pos.copy()
q2.dtypes
q2.to_datetime(q2.Date).dt.year
q2.to_datetime(q2.Date).dt.month
pd.to_datetime(q2.Date).dt.day_name(locale='ko_kr') #기본은 영어 

q2['month']=pd.to_datetime(q2.Date).dt.month
q2['day']=pd.to_datetime(q2.Date).dt.day_name(locale='ko_kr')

q2_merge = pd.merge(q2,lis,left_on='itemDescription',
                    right_on='prod_nm',
                    how='left')
